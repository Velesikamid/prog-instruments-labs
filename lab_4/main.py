...
def main() -> int:
    ...
    try:
        ...
        comments: list[str] = get_list_of_people(comments, settings["blacklist"], bool(int(input("Кого ищем (0 - нестудентов, 1 - студентов)? "))))
        path_to_result: Optional[str] = write_to_file(comments, input("Введите путь к файлу, куда сохранить результат: "))
        print(
